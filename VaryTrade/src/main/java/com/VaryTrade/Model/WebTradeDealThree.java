...
public class WebTradeDealThree implements Serializable, WebTradeDeal {
	private static final long serialVersionUID = 1L;
	private ArrayList<WebTradeItem> posterTradeItems;
	private ArrayList<WebTradeItem> accepterTradeItems;

	public WebTradeDealThree() {
		posterTradeItems = new ArrayList<WebTradeItem>();
		accepterTradeItems = new ArrayList<WebTradeItem>();
	}

	public WebTradeDealThree(ArrayList<WebTradeItem> posterTradeItems, ArrayList<WebTradeItem> accepterTradeItems) {
